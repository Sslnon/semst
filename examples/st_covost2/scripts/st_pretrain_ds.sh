...
source=covost4en
wandb_exp_name=Semst_${source}_enst_1e5lr_24bsz_${gpu_count}gpu_fixprompt
output_dir=/Work21/2024/lixuanchen/project/semst/examples/st_covost2/outputs/${wandb_exp_name}
ds_config=/Work21/2024/lixuanchen/project/semst/examples/st_covost2/conf/st_ds_config.json
...
train_data_path=/Work21/2024/lixuanchen/project/ic26/data/covost2/covost_enasr+st_train_clean.jsonl  # TODO
val_data_path=/Work21/2024/lixuanchen/project/ic26/data/covost2/covost_enasr+st_dev.jsonl
...
ckpt_name="/Work21/2024/lixuanchen/project/semst/examples/st_covost2/outputs/Semst_covost4en_asr_adp_32bsz_2gpu/asr_epoch_2_step_22721/global_step12960/mp_rank_00_model_states.pt"
...
++train_config.total_steps=289384 \
...
++log_config.wandb_project_name=Semst_st_adp \
